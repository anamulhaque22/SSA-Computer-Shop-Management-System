...
{
    public class AdminEmployeeLogged:AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            else if (!AuthService.IsAdminTokenVaild(token.ToString()) && !AuthService.IsTokenVaild(token.ToString()))
            {
